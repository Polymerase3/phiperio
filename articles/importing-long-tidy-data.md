...
#> [11:52:13] INFO  Constructing <phip_data> object
#>                  -> create_data()
#> [11:52:13] INFO  Fetching peptide metadata library via get_peptide_library()
#> [11:52:13] INFO  Retrieving peptide metadata into DuckDB cache
#>                  -> get_peptide_library(force_refresh = FALSE)
#> [11:52:13] INFO  Opened DuckDB connection
#>                    - cache dir:
#>                      /home/runner/.cache/R/phiperio/peptide_meta/phip_cache.duckdb
#>                    - table: peptide_meta
#> [11:52:13] OK    Using cached peptide_meta (fast path)
#> [11:52:13] OK    Retrieving peptide metadata into DuckDB cache - done
#>                  -> elapsed: 0.229s
#> [11:52:13] OK    Peptide metadata acquired
#> [11:52:13] INFO  Validating <phip_data>
#>                  -> validate_phip_data()
#> [11:52:13] INFO  Checking structural requirements (shape & mandatory columns)
#> [11:52:13] INFO  Checking outcome family availability (exist / fold_change /
#>                  raw_counts)
#> [11:52:13] INFO  Checking collisions with reserved names
#>                    - subject_id, sample_id, timepoint, peptide_id, exist,
#>                      fold_change, counts_input, counts_hit
#> [11:52:13] INFO  Ensuring all columns are atomic (no list-cols)
#> [11:52:13] INFO  Checking key uniqueness
#> [11:52:13] INFO  Validating value ranges & types for outcomes
#> Warning: Missing values are always removed in SQL aggregation functions.
#> Use `na.rm = TRUE` to silence this warning
#> This warning is displayed once every 8 hours.
#> [11:52:13] INFO  Assessing sparsity (NA/zero prevalence vs threshold)
#>                    - warn threshold: 50%
#> [11:52:13] INFO  Checking peptide_id coverage against peptide_library
#> Warning: [11:52:13] WARN  peptide_id not found in peptide_library (e.g. p1)
#>                  -> peptide library coverage.
#> [11:52:13] INFO  Checking full grid completeness (peptide * sample)
#> [11:52:13] OK    Counts table is a full peptide * sample grid
#> [11:52:13] OK    Validating <phip_data> - done
#>                  -> elapsed: 0.658s
#> [11:52:13] OK    Constructing <phip_data> object - done
#>                  -> elapsed: 0.89s
...
#> # Database: DuckDB 1.4.4 [unknown@Linux 6.11.0-1018-azure:R 4.5.2//tmp/RtmpEuh0tR/phiperio_cache1f717f69cc09/phip_cache.duckdb]
#>   sample_id peptide_id exist fold_change   age sex  
#>   <chr>     <chr>      <dbl>       <dbl> <dbl> <chr>
#> 1 s1        p1             1         1.2    34 F    
#> 2 s1        p2             0         0.8    34 F    
...
out_parquet
#> [1] "/tmp/RtmpEuh0tR/file1f716feb8c05.parquet"
...
#> Skipping ANALYZE - raw_combined is a view.
#> [11:52:14] INFO  Constructing <phip_data> object
#>                  -> create_data()
#> [11:52:14] INFO  Fetching peptide metadata library via get_peptide_library()
#> [11:52:14] INFO  Retrieving peptide metadata into DuckDB cache
#>                  -> get_peptide_library(force_refresh = FALSE)
#> [11:52:14] INFO  Opened DuckDB connection
#>                    - cache dir:
#>                      /home/runner/.cache/R/phiperio/peptide_meta/phip_cache.duckdb
#>                    - table: peptide_meta
#> [11:52:14] OK    Using cached peptide_meta (fast path)
#> [11:52:14] OK    Retrieving peptide metadata into DuckDB cache - done
#>                  -> elapsed: 0.208s
#> [11:52:14] OK    Peptide metadata acquired
#> [11:52:14] INFO  Validating <phip_data>
#>                  -> validate_phip_data()
#> [11:52:14] INFO  Checking structural requirements (shape & mandatory columns)
#> [11:52:14] INFO  Checking outcome family availability (exist / fold_change /
#>                  raw_counts)
#> [11:52:14] INFO  Checking collisions with reserved names
#>                    - subject_id, sample_id, timepoint, peptide_id, exist,
#>                      fold_change, counts_input, counts_hit
#> [11:52:14] INFO  Ensuring all columns are atomic (no list-cols)
#> [11:52:14] INFO  Checking key uniqueness
#> [11:52:14] INFO  Validating value ranges & types for outcomes
#> [11:52:14] INFO  Assessing sparsity (NA/zero prevalence vs threshold)
#>                    - warn threshold: 50%
#> [11:52:14] INFO  Checking peptide_id coverage against peptide_library
#> Warning: [11:52:14] WARN  peptide_id not found in peptide_library (e.g. p1)
#>                  -> peptide library coverage.
#> [11:52:14] INFO  Checking full grid completeness (peptide * sample)
#> [11:52:14] OK    Counts table is a full peptide * sample grid
#> [11:52:14] OK    Validating <phip_data> - done
#>                  -> elapsed: 0.463s
#> [11:52:14] OK    Constructing <phip_data> object - done
#>                  -> elapsed: 0.673s
pd_xc_again
#> ── <phip_data> ───────────────────────────────────────────────────────────────── 
#> 
...
#> Skipping ANALYZE - raw_combined is a view.
#> [11:52:15] INFO  Constructing <phip_data> object
#>                  -> create_data()
#> [11:52:15] INFO  Validating <phip_data>
#>                  -> validate_phip_data()
#> [11:52:15] INFO  Checking structural requirements (shape & mandatory columns)
#> [11:52:15] INFO  Checking outcome family availability (exist / fold_change /
#>                  raw_counts)
#> [11:52:15] INFO  Checking collisions with reserved names
#>                    - subject_id, sample_id, timepoint, peptide_id, exist,
#>                      fold_change, counts_input, counts_hit
#> [11:52:15] INFO  Ensuring all columns are atomic (no list-cols)
#> [11:52:15] INFO  Checking key uniqueness
#> [11:52:15] INFO  Validating value ranges & types for outcomes
#> [11:52:15] INFO  Assessing sparsity (NA/zero prevalence vs threshold)
#>                    - warn threshold: 50%
#> [11:52:15] INFO  Checking peptide_id coverage against peptide_library
#> [11:52:15] INFO  Checking full grid completeness (peptide * sample)
#> Warning: [11:52:15] WARN  Counts table is not a full peptide * sample grid.
#>                  -> grid completeness
#>                    - observed rows: 6
#>                    - expected rows: 12.
#> Warning: [11:52:15] WARN  Grid remains incomplete (auto_expand = FALSE).
#>                  -> grid completeness
#>                    - observed rows: 6
#>                    - expected rows: 12.
#> [11:52:15] OK    Validating <phip_data> - done
#>                  -> elapsed: 0.341s
#> [11:52:15] OK    Constructing <phip_data> object - done
#>                  -> elapsed: 0.342s
```
...
out_parquet_lg
#> [1] "/tmp/RtmpEuh0tR/file1f713c822a9b.parquet"
```
...
#> [11:52:16] INFO  Constructing <phip_data> object
#>                  -> create_data()
#> [11:52:16] INFO  Fetching peptide metadata library via get_peptide_library()
#> [11:52:16] INFO  Retrieving peptide metadata into DuckDB cache
#>                  -> get_peptide_library(force_refresh = FALSE)
#> [11:52:16] INFO  Opened DuckDB connection
#>                    - cache dir:
#>                      /home/runner/.cache/R/phiperio/peptide_meta/phip_cache.duckdb
#>                    - table: peptide_meta
#> [11:52:16] OK    Using cached peptide_meta (fast path)
#> [11:52:16] OK    Retrieving peptide metadata into DuckDB cache - done
#>                  -> elapsed: 0.203s
#> [11:52:16] OK    Peptide metadata acquired
#> [11:52:16] INFO  Validating <phip_data>
#>                  -> validate_phip_data()
#> [11:52:16] INFO  Checking structural requirements (shape & mandatory columns)
#> [11:52:16] INFO  Checking outcome family availability (exist / fold_change /
#>                  raw_counts)
#> [11:52:16] INFO  Checking collisions with reserved names
#>                    - subject_id, sample_id, timepoint, peptide_id, exist,
#>                      fold_change, counts_input, counts_hit
#> [11:52:16] INFO  Ensuring all columns are atomic (no list-cols)
#> [11:52:16] INFO  Checking key uniqueness
#> [11:52:16] INFO  Validating value ranges & types for outcomes
#> [11:52:16] INFO  Assessing sparsity (NA/zero prevalence vs threshold)
#>                    - warn threshold: 50%
#> [11:52:16] INFO  Checking peptide_id coverage against peptide_library
#> Warning: [11:52:16] WARN  peptide_id not found in peptide_library (e.g. 10003)
#>                  -> peptide library coverage.
#> [11:52:16] INFO  Checking full grid completeness (peptide * sample)
#> Warning: [11:52:16] WARN  Counts table is not a full peptide * sample grid.
#>                  -> grid completeness
#>                    - observed rows: 78200
#>                    - expected rows: 156000.
#> Warning: [11:52:16] WARN  Grid remains incomplete (auto_expand = FALSE).
#>                  -> grid completeness
#>                    - observed rows: 78200
#>                    - expected rows: 156000.
#> [11:52:16] OK    Validating <phip_data> - done
#>                  -> elapsed: 0.545s
#> [11:52:16] OK    Constructing <phip_data> object - done
#>                  -> elapsed: 0.75s
ex
#> ── <phip_data> ───────────────────────────────────────────────────────────────── 
#> 
